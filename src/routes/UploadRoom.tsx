import { Text, Box, Button, Checkbox, Container, FormControl, FormHelperText, FormLabel, Grid, Heading, Input, InputGroup, InputLeftAddon, Select, Textarea, VStack, useToast } from "@chakra-ui/react";
        ...
        <Container>
            ...
            <VStack spacing={10} as="form" onSubmit={handleSubmit(onSubmit)} mt={5}>
                ...
                <FormControl>
                    ...
                    <FormHelperText>What kind of room of are you renting?</FormHelperText>
                </FormControl>
                <FormControl>
                ...
                {mutations.isError ? (<Text color="red.500">Something went wrong</Text>) : null}
                <Button type="submit" isLoading={mutations.isLoading} colorScheme={"red"} size="lg" w="100%">Upload Room</Button>
            </VStack> 
        </Container>
        </Box>
    </ProtectedPage>
